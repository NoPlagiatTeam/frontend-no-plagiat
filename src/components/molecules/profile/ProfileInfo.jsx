import {getUserDataFromStorage} from "../../../utils/storageData.js";
...
function ProfileInfo() {
    ...
    return (
        <div
            className="w-full md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
